...
const UpdatePassword: React.FC = () => {
    ...
    const handleUpdatePassword = async (e: FormEvent<HTMLFormElement>) => {
        try {
            e.preventDefault()
            if (!data.oldPassword || !data.newPassword) return toast.error("Please fill all the fields")
            await useUpdatePassword({ data, setIsLoggedIn, setLoading })
        } catch (error) {
            console.log(error);
        }
    }
                ...
                <div className="mt-6  w-full">
                    ...
                    <div className="relative flex items-center justify-center">
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setData({ ...data, oldPassword: e.target.value })}
                ...
                <div className="mt-6  w-full">
                    ...
                    <div className="relative flex items-center justify-center">
                        <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setData({ ...data, newPassword: e.target.value })}
