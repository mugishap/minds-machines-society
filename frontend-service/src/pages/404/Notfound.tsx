...
const NotFound: React.FC<{}> = () => {
    React.useEffect(() => {
        document.title = "404 | Minds, Machines and Society"
    }, [])
    return (
        ...
        <div className="w-full bg-[#EDEDED] min-h-screen">
            <main className="w-full flex items-center justify-center flex-col pt-12 pb-16">
                <section className="relative flex flex-col">
                    ...
                    <div className="absolute bg-white bottom-12 h-[30%] w-full"></div>
                </section>
                ...
                <Link to="/">
                    <button className="text-white bg-[#263048] rounded py-3 px-8 text-lg">
                        Back To Home Page
                    </button>
                </Link>
            </main>
