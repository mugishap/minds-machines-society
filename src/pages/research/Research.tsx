...
const Research: React.FC = () => {
    return (
        <Layout>
            <span className='font-bold text-2xl dark:text-white'>Below is an overview of the technical areas currently being researched by the Minds, Machines, and Society group:</span>
            <div className='flex flex-col my-6 w-full'>
                {
                    researches.map((research: IResearch, index: number) => {
                        return (
                            <div className='flex flex-col w-full dark:text-white my-6' key={index}>
                                <span className='font-semibold text-xl'>{research.heading}</span>
                                <div className='w-full flex justify-between'>
                                    <div className='w-8/12 flex flex-col'>
                                        <span className='text-[#222222] my-6 dark:text-white'>{research.subheading}</span>
